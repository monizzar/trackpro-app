...
export function CutterSidebar() {
    ...
    const menuItems = [
        { icon: LayoutDashboard, label: "Dashboard", href: "/cutter/dashboard" },
        { icon: Scissors, label: "Proses Pemotongan", href: "/cutter/process" },
        { icon: History, label: "Riwayat Kerja", href: "/cutter/history" },
    ]
    ...
    return (
        <div className="flex h-full w-64 flex-col bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900 border-r text-white">
            ...
            <div className="flex h-16 items-center gap-2 border-b px-6">
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-600" />
                <div>
                    <div className="font-semibold text-foreground">TrackPro</div>
                    <div className="text-xs text-muted-foreground">Cutter System</div>
                </div>
            </div>
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger className="flex w-full items-center gap-3 rounded-lg p-2 hover:bg-accent transition-colors">
                        ...
                        <div className="flex flex-col items-start flex-1 min-w-0">
                            <p className="text-sm font-medium text-foreground">Pemotong</p>
                            <p className="text-xs text-muted-foreground truncate w-full">ahmad@trackpro.com</p>
                        </div>
                    </DropdownMenuTrigger>
